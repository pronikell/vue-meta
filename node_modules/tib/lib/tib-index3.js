...
class SeleniumWebpage extends webpage.Webpage {
  ...
  runScript(fn, ...args) {
    ...
    if (typeof fn === 'function') {
      parsedFn = webpage.parseFunction(fn, this.getBabelPresetOptions());
    } else {
      parsedFn = fn;
    }
...
class SeleniumBrowser extends index.Browser {
  ...
  _page(url, readyCondition) {
    const page = new SeleniumWebpage(this);
    return page.open(url, readyCondition)
  }
}

exports.default = SeleniumBrowser;
