...
class SauceLabsBrowser extends logging.SeleniumLogging(index['default']) {
  ...
  constructor(config) {
    ...
    throw new index$1.BrowserError(this, 'SauceLabs not yet implemented')
  }
...
exports.default = SauceLabsBrowser;
